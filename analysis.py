...
all_words = []
outstr = ''
for filename in os.listdir(str(singerId)):
    with open(str(singerId) + '/' + filename) as f:
        lyrics = f.read()
...
color_mask = imageio.imread('xinxing.jpg')  # 背景图
cloud = WordCloud(
...
world_cloud.to_file(str(singerId) + '.jpg')
